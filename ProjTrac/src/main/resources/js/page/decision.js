                 ...
                 columns: [
                     ...
                     { data: null, title: "Currency",
                    	 ...
                    	 "render": function(data, type, row, meta){
                   		   ...
                   		   data =  dsiplayCurrency(row.appId);
                   		   return data;
                   	   }
                     },
	...
	$.ajax({ 
        ...
        success: function(data){
        	...
        	$('#ApplicationDetails').DataTable({
        	      ...
        	      //scroll to Application Details view
        	      $('html,body').animate({scrollTop: $("#appDetails").offset().top},'slow'); 
        }
...
function dsiplayCurrency(appId){
	var currency;
	var myUrl = "appDtlscurr/"+appId;
	$.ajax({ 
        type: "GET",
        dataType: "text",
        url: myUrl,
